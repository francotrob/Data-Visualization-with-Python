...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        ...
        R_chart2  = dcc.Graph(
            figure=px.bar(average_sales, 
                x='Vehicle_Type',
                y='Automobile_Sales',
                title='Average Automobile Sales fluctuation by Vehicle Type over Recession Period'))
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        unemp_data = recession_data.groupby('Vehicle_Type').agg({'Unemployment_Rate':'mean', 'Automobile_Sales':'mean'}).reset_index()                           
        R_chart4 = dcc.Graph(
...
# Plot 2 Total Monthly Automobile sales using line chart.
        ...
        Y_chart4 = dcc.Graph(
            ...
            values='Advertisement Expenditure',
            names='Vehicle_Type',
